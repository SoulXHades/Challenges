/*
1. Write a function removeUntil() that pops all values off a stack of integers down to but not
...
queue of integers. The prototype for the recursiveReverse() function is given below:

void recursiveReverse(Queue *q);


3. Write a function palindrome() that determines whether a given string is a palindrome. The
prototype for the palindrome() function is given below:
...
()[]{} is balanced. The prototype for the balanced() function is given below:

int balanced(char *expression);

The following expressions are balanced because the order and quantity of the parentheses
match:
()
([])
{[]()[]}
