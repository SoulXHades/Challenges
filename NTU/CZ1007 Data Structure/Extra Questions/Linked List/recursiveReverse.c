/*
Write a C function recursiveReverse()that recursively reverses the given linked list
by changing its next pointer and its head pointer.
...
void RecursiveReverse(ListNode **ptrHead)
{
    ...
    *ptrHead = (*ptrHead)->next;
    ...
    //example 2 -> 3, so LN is 2 hence change 3's next ptr to point to 2
    LN->next->next = LN;
    LN->next = NULL;
}
