...
## Switches
set_property PACKAGE_PIN V17 [get_ports fifty]
	set_property IOSTANDARD LVCMOS33 [get_ports fifty]
set_property PACKAGE_PIN V16 [get_ports dollar]
	set_property IOSTANDARD LVCMOS33 [get_ports dollar]
set_property PACKAGE_PIN W16 [get_ports cancel]
...
set_property PACKAGE_PIN E19 [get_ports insert_coin]
	set_property IOSTANDARD LVCMOS33 [get_ports insert_coin]
set_property PACKAGE_PIN U19 [get_ports dispense]
