/*
Write a C function write a function isStackPairwiseConsecutive()
...
A sample input and output session is given below (if the current stack is -2 -1 11 10 4 3 2 1):

       1: Enter integer values to push into the stack;
       ...
       Enter integer values to push into the stack: 1 2 3 4 10 11 -1 -2

       The Stack is: -2 -1 11 10 4 3 2 1
...
A sample input and output session is given below (if the current stack is -2 -1 15 10 4 3 2 1):
     ...
     Enter integer values to push into the stack: 1 2 3 4 10 15 -1 -2

     The Stack is: -2 -1 15 10 4 3 2 1
    ...
    The stack is not pairwise consecutive.
     ...
     A sample input and output session is given below (if the current stack is 10 11 4 5 3 4 20):
    ...
    Enter integer values to push into the stack: 20 4 3 5 4 11 10

    The Stack is: 10 11 4 5 3 4 20
